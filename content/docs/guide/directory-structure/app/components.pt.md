...
If you want to auto-import components from an npm package, you can use ``addComponent`` in a [local module](/docs/guide/directory-structure/modules) to register them.
