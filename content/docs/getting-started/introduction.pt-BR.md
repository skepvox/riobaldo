...
- **File-based routing:** define routes based on the structure of your `pages/` directory (broken link). This can make it easier to organize your application and avoid the need for manual route configuration.
