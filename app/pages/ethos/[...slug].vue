...
// Get ethos navigation - simplified version without versioning
...
const links = computed(() => headerLinks.value.find(link => link.to === '/ethos')?.children ?? [])
...
const titleTemplate = computed(() => page.value?.titleTemplate || '%s · Ethos')
