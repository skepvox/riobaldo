...
const _assets = {
  ["nuxt-og-image:fonts:Inter-normal-400.ttf.base64"]: {
    ...
    meta: {"type":"text/plain; charset=utf-8","etag":"\"652cc-qEeSD1DXCSV8gPP2rnBA6ePGdZ4\"","mtime":"2025-08-21T01:34:54.697Z"}
  },
  ["nuxt-og-image:fonts:Inter-normal-700.ttf.base64"]: {
    import: () => import('../raw/Inter-normal-700.ttf.mjs').then(r => r.default || r),
    meta: {"type":"text/plain; charset=utf-8","etag":"\"674f0-FZReUXHhPTnY0HmYVn2iPpKm9ds\"","mtime":"2025-08-21T01:34:54.697Z"}
  }
};
...
const appConfig0 = defineAppConfig({
  ...
  footer: {
    credits: `Copyright \xA9 ${(/* @__PURE__ */ new Date()).getFullYear()} Thiago Oliveira`,
    colorMode: false,
    links: [
      {
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "cb4e4b91-bcdb-4f2a-b4c2-3646a28c2a11",
  ...
  "nitro": {
    ...
    "routeRules": {
      ...
      "/__nuxt_content/matematica/sql_dump.txt": {
        "prerender": true
      },
      "/__nuxt_content/filosofia/sql_dump.txt": {
        "prerender": true
      },
      "/_nuxt/builds/meta/**": {
        "headers": {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/skepvox/riobaldo/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "nuxt-site-config": {
...
const _nk2Z89AlfCWbahIMVRIFHc9M3DLsFOLp5yMuAzuYQ = defineNitroPlugin(async (nitroApp) => {
...
const _CEpXi2YIkOu1qYFWaxnrVy2rkU4iZ41AnniOrYeB8 = defineNitroPlugin(async (nitro) => {
  return;
});
...
const _SQ29jeoNqHZ1NT962dkaci1SW9Cm21Nd7pxUUNsGM = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
...
const _2EGNmyfjNv4pY4o7RyTXRCo0goDjYekUp3GsLco7A8 = (function(nitro) {
...
const plugins = [
  _nk2Z89AlfCWbahIMVRIFHc9M3DLsFOLp5yMuAzuYQ,
_CEpXi2YIkOu1qYFWaxnrVy2rkU4iZ41AnniOrYeB8,
_SQ29jeoNqHZ1NT962dkaci1SW9Cm21Nd7pxUUNsGM,
_2EGNmyfjNv4pY4o7RyTXRCo0goDjYekUp3GsLco7A8
];
...
const checksumsStructure = {
  ...
  "matematica": "qzWQwEsO1JiYn41rF4P0HYrcg8JO9LvHZVNDk9ZD3xM",
  "filosofia": "e-lm44oXvp48w581lEy5ncEDOv3yUlPLsdB3JJFJfHs"
};
...
const _pge_oc = defineCachedEventHandler(async (event) => {
  const url = getRequestURL(event);
  if (!url)
...
const _ouMsG1 = eventHandler(async (e) => {
...
const _pET7oM = _messagesHandlerCached;
...
const _fKI8vy = eventHandler(async (event) => {
...
const _ntUTUi = eventHandler(async (event) => {
...
const _aht6F7 = lazyEventHandler(() => {
...
const _lazy_HrqRK9 = () => import('../routes/renderer.mjs');
const _lazy_8gOKaw = () => import('../routes/__og-image__/font/font.mjs');
const _lazy_hSgM_f = () => import('../routes/__og-image__/image/image.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_HrqRK9, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _pge_oc, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_8gOKaw, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _ouMsG1, lazy: false, middleware: true, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_hSgM_f, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/static/**', handler: _lazy_hSgM_f, lazy: true, middleware: false, method: undefined },
  { route: '/_i18n/:locale/messages.json', handler: _pET7oM, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _fKI8vy, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _ntUTUi, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _aht6F7, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_HrqRK9, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, fetchIsland as A, createHeadCore as B, normaliseFontInput as C, theme as D, withTrailingSlash as E, handleCacheHeaders as F, setHeaders as G, setHeader as H, hash$1 as I, resolveContext as J, H3Error as K, parseURL as L, setResponseHeader as M, proxyRequest as N, sendRedirect as O, serialize$1 as P, defuFn as Q, useSeoMeta as R, defu as S, headSymbol as T, klona as U, useHead as V, isEqual as W, getContext as X, sanitizeStatusCode as Y, baseURL as Z, resolveUnrefHeadInput as _, getResponseStatus as a, createHooks as a0, executeAsync as a1, toRouteMatcher as a2, createRouter$1 as a3, getRequestURL as a4, pascalCase as a5, getRequestHeader as a6, parse as a7, setCookie as a8, getCookie as a9, deleteCookie as aa, decodeHtml as ab, logger as ac, toBase64Image as ad, withBase as ae, htmlDecodeQuotes as af, sendError as ag, fontCache as ah, kebabCase as ai, listener as aj, appId as b, buildAssetsURL as c, defineRenderHandler as d, appTeleportTag as e, appTeleportAttrs as f, getResponseStatusText as g, getQuery as h, createError$1 as i, createSSRContext as j, appHead as k, destr as l, getRouteRules as m, getRenderer as n, getEntryIds as o, publicAssetsURL as p, replaceIslandTeleports as q, renderInlineStyles as r, setSSRError as s, defineEventHandler as t, useNitroApp as u, prefixStorage as v, useNitroOrigin as w, useStorage as x, emojiCache as y, useOgImageRuntimeConfig as z };
