...
import { u as useAppConfig, r as reactivePick, t as tv$1, _ as _sfc_main$w, e as _sfc_main$t } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const ui = computed(() => tv$1({ extend: tv$1(theme), ...appConfig.ui?.separator || {} })({
      color: props.color,
              ...
              __props.label || __props.icon || __props.avatar || !!slots.default ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                createVNode("div", {
                  ...
                  renderSlot(_ctx.$slots, "default", {}, () => [
                    ...
                    }, toDisplayString(__props.label), 3)) : __props.icon ? (openBlock(), createBlock(_sfc_main$w, {
                      key: 1,
                      name: __props.icon,
                      class: ui.value.icon({ class: props.ui?.icon })
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@3.2.0_@babel+parser@7.28.0_@netlify+blobs@9.1.2_db0@0.3.2_better-sqlite3@12.2._ed31a72b5066dafc351ea9873dbff10b/node_modules/@nuxt/ui/dist/runtime/components/Separator.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as _ };
//# sourceMappingURL=Separator-CkH4gGaX.mjs.map
