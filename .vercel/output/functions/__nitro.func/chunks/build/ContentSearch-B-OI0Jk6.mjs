import { x as useLocalePro, y as useContentSearch, z as useColorMode, u as useAppConfig, r as reactivePick, o as omit, A as tv, B as _sfc_main$h, C as transformUI, q as useDebounceFn, s as useKbd, v as useActiveElement, w as useEventListener, f as useLocale, t as tv$1, g as _sfc_main$q, h as get, j as _sfc_main$r, p as pickLinkProps, k as _sfc_main$s, _ as _sfc_main$w, e as _sfc_main$t, m as _sfc_main$u, n as _sfc_main$c, a as useFormField, b as useButtonGroup, d as useComponentIcons, l as looseToNumber } from './server.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const ui = computed(() => tv$1({ extend: tv$1(theme$2), ...appConfig.ui?.input || {} })({
      type: props.type,
      color: color.value,
            ...
            return [
              ...
              unref(isTrailing) || !!slots.trailing ? (openBlock(), createBlock("span", {
                ...
                renderSlot(_ctx.$slots, "trailing", {}, () => [
                  unref(trailingIconName) ? (openBlock(), createBlock(_sfc_main$w, {
                    key: 0,
                    name: unref(trailingIconName),
                    class: ui.value.trailingIcon({ class: props.ui?.trailingIcon })
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@3.2.0_@babel+parser@7.28.0_@netlify+blobs@9.1.2_db0@0.3.2_better-sqlite3@12.2._ed31a72b5066dafc351ea9873dbff10b/node_modules/@nuxt/ui/dist/runtime/components/Input.vue");
...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => tv$1({ extend: tv$1(theme$1), ...appConfig.ui?.commandPalette || {} })());
                      ...
                      fn: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ssrRenderSlot(_ctx.$slots, "back", { ui: ui.value }, () => {
                            _push4(ssrRenderComponent(_sfc_main$q, mergeProps({
                                              ...
                                              if (_push7) {
                                                ssrRenderSlot(_ctx.$slots, item.slot || group.slot || "item", {
                                                  ...
                                                  ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : group.slot ? `${group.slot}-leading` : `item-leading`, {
                                                    ...
                                                    if (item.loading) {
                                                      _push7(ssrRenderComponent(_sfc_main$w, {
                                                      ...
                                                      _push7(ssrRenderComponent(_sfc_main$t, mergeProps({
                                                      ...
                                                      _push7(ssrRenderComponent(_sfc_main$u, mergeProps({
                                                  ...
                                                  renderSlot(_ctx.$slots, item.slot || group.slot || "item", {
                                                    ...
                                                    renderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : group.slot ? `${group.slot}-leading` : `item-leading`, {
                                                      ...
                                                      item.loading ? (openBlock(), createBlock(_sfc_main$w, {
                                                        ...
                                                        class: ui.value.itemLeadingAvatar({ class: [props.ui?.itemLeadingAvatar, item.ui?.itemLeadingAvatar], active: active || item.active })
                                                      }), null, 16, ["size", "class"])) : item.chip ? (openBlock(), createBlock(_sfc_main$u, mergeProps({
                                                        key: 3,
                                                        size: item.ui?.itemLeadingChipSize || props.ui?.itemLeadingChipSize || ui.value.itemLeadingChipSize(),
                                                        inset: "",
                                                        standalone: ""
                                                    ...
                                                    createVNode("span", {
                                                      ...
                                                      renderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : group.slot ? `${group.slot}-trailing` : `item-trailing`, {
                                                        ...
                                                        item.children && item.children.length > 0 ? (openBlock(), createBlock(_sfc_main$w, {
                                                          key: 0,
                                                          name: __props.trailingIcon || unref(appConfig).ui.icons.chevronRight,
                                                          class: ui.value.itemTrailingIcon({ class: [props.ui?.itemTrailingIcon, item.ui?.itemTrailingIcon] })
                                                        ...
                                                        ], 2)) : group.highlightedIcon ? (openBlock(), createBlock(_sfc_main$w, {
                                                          key: 2,
                                                          name: group.highlightedIcon,
                                                          class: ui.value.itemTrailingHighlightedIcon({ class: [props.ui?.itemTrailingHighlightedIcon, item.ui?.itemTrailingHighlightedIcon] })
                                                        }, null, 8, ["name", "class"])) : createCommentVNode("", true)
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@3.2.0_@babel+parser@7.28.0_@netlify+blobs@9.1.2_db0@0.3.2_better-sqlite3@12.2._ed31a72b5066dafc351ea9873dbff10b/node_modules/@nuxt/ui/dist/runtime/components/CommandPalette.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui-pro@3.2.0_@babel+parser@7.28.0_@netlify+blobs@9.1.2_db0@0.3.2_better-sqlite3@1_abd900d3314e4a9a03512da03be3832c/node_modules/@nuxt/ui-pro/dist/runtime/components/content/ContentSearch.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=ContentSearch-B-OI0Jk6.mjs.map
