import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { v as prefixStorage, w as useNitroOrigin, x as useStorage, y as emojiCache, z as useOgImageRuntimeConfig, i as createError, A as fetchIsland, B as createHeadCore, C as normaliseFontInput, D as theme, E as withTrailingSlash, h as getQuery, F as handleCacheHeaders, G as setHeaders, H as setHeader, I as hash, J as resolveContext, K as H3Error, L as parseURL, M as setResponseHeader, N as proxyRequest, O as sendRedirect } from '../nitro/nitro.mjs';
